...
function updatePositions() {
  ...
  var sc = document.body.scrollTop / 1250;

  
  var phases = []; 

  for (var i = 0; i < 5; i++) {
   phases.push(Math.sin(sc + (i % 5)));
  }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var movingPizzas = document.getElementById("movingPizzas1"); //Change document.querySelector() to document.getElementById();
  var cols = 8;
  var s = 256;
  var elem;
